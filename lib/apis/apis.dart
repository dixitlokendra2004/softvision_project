...
import 'package:softvision_project/apis/user_error.dart';
...
class Apis {
  static Future<Object> apiCall(
    ...
    headers ??= (apiType == "PUT" || !applicationJson)
        ? {
      'Authorization':
      "Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJVU0VSX0NPREUiOjEsImlhdCI6MTcxMDY4Mzk4Mn0.BoAlUjUjX2gQJbNq92aitMUDOM5wU7tM1Ptdffug6I8"
    ...
    log("multipartFiles: $multipartFiles");
    ...
    if (isMultipart) {
      ...
      log("multipartRequest.files ${multipartRequest.files}");
