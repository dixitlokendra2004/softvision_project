...
class OtpVerificationUser extends StatefulWidget {
  ...
  String type;
  OtpVerificationUser( this.smsToSend, this.otpForVerification, this.requestBody, this.type, {super.key});

  @override
  State<OtpVerificationUser> createState() => OtpVerificationUserState();
}

class OtpVerificationUserState extends State<OtpVerificationUser> {
  TextEditingController textEditingController = TextEditingController();
  StreamController<ErrorAnimationType>? errorController;
  late OtpVerificationUserViewModel _viewModel;
  ...
  Widget build(BuildContext context) {
    _viewModel = context.watch<OtpVerificationUserViewModel>();
    return Scaffold(
      appBar: AppBar(
        title: Text(
